...
export default function Installer({ onComplete }) {
  ...
  const handleFinishLaunch = async () => {
    ...
    if (completeInstallation) {
      setLaunching(true);
      try {
        await completeInstallation(installData);
      } catch (err) {
        setLaunching(false);
        setLaunchError(err.message || 'Could not create the owner account. Check the API is reachable and try again.');
        return;
      }
      setLaunching(false);
    } else if (onComplete) {
                ...
                <div>
                  ...
                  <input 
                    ...
                    style={{ 
                      ...
                      padding: '10px 14px', 
                      borderRadius: '10px', 
                      backgroundColor: fieldErrors.mailHost ? '#451a1a' : '#1e293b', 
                      border: fieldErrors.mailHost ? '3px solid #ef4444' : '1px solid #334155', 
                      color: fieldErrors.mailHost ? '#f87171' : '#f8fafc', 
                      fontSize: '13px', 
                      outline: 'none',
                ...
                <div>
                  ...
                  <input 
                    ...
                    style={{ 
                      ...
                      padding: '10px 14px', 
                      borderRadius: '10px', 
                      backgroundColor: fieldErrors.mailPort ? '#451a1a' : '#1e293b', 
                      border: fieldErrors.mailPort ? '3px solid #ef4444' : '1px solid #334155', 
                      color: fieldErrors.mailPort ? '#f87171' : '#f8fafc', 
                      fontSize: '13px', 
                      outline: 'none',
                ...
                <div>
                  ...
                  <input 
                    ...
                    style={{ 
                      ...
                      padding: '10px 14px', 
                      borderRadius: '10px', 
                      backgroundColor: fieldErrors.mailUsername ? '#451a1a' : '#1e293b', 
                      border: fieldErrors.mailUsername ? '3px solid #ef4444' : '1px solid #334155', 
                      color: fieldErrors.mailUsername ? '#f87171' : '#f8fafc', 
                      fontSize: '13px', 
                      outline: 'none',
                ...
                <div>
                  ...
                  <input 
                    ...
                    style={{ 
                      ...
                      padding: '10px 14px', 
                      borderRadius: '10px', 
                      backgroundColor: fieldErrors.mailPassword ? '#451a1a' : '#1e293b', 
                      border: fieldErrors.mailPassword ? '3px solid #ef4444' : '1px solid #334155', 
                      color: fieldErrors.mailPassword ? '#f87171' : '#f8fafc', 
                      fontSize: '13px', 
                      outline: 'none',
                ...
                <div>
                  ...
                  <input 
                    ...
                    style={{ 
                      ...
                      padding: '10px 14px', 
                      borderRadius: '10px', 
                      backgroundColor: fieldErrors.fromAddress ? '#451a1a' : '#1e293b', 
                      border: fieldErrors.fromAddress ? '3px solid #ef4444' : '1px solid #334155', 
                      color: fieldErrors.fromAddress ? '#f87171' : '#f8fafc', 
                      fontSize: '13px', 
                      outline: 'none',
                ...
                <div>
                  ...
                  <input 
                    ...
                    style={{ 
                      ...
                      padding: '10px 14px', 
                      borderRadius: '10px', 
                      backgroundColor: fieldErrors.fromName ? '#451a1a' : '#1e293b', 
                      border: fieldErrors.fromName ? '3px solid #ef4444' : '1px solid #334155', 
                      color: fieldErrors.fromName ? '#f87171' : '#f8fafc', 
                      fontSize: '13px', 
                      outline: 'none',
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', alignItems: 'center', textAlign: 'center', padding: '20px 0' }}>
              ...
              {!isFinished ? (
                ...
                <>
                  ...
                  {launchError && (
                    <div style={{ color: '#fca5a5', fontSize: '13px', fontWeight: '600', marginTop: '4px' }}>⚠️ {launchError}</div>
                  )}
                  ...
                  >
                    {launching ? 'Creating owner account…' : <>Launch Pharmacy Welcome Page ➔</>}
                  </button>
                </>
              )}
            </div>
