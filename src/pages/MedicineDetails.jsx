...
export default function MedicineDetails() {
  ...
  const dealer = dealers.find(d => 
    d.name.toLowerCase().includes(medicine.dealer.toLowerCase()) || 
    medicine.dealer.toLowerCase().includes(d.name.toLowerCase())
  ) || { name: medicine.dealer, contactPerson: 'Unknown', phone: 'N/A', email: 'N/A', pendingOrders: 0 };
