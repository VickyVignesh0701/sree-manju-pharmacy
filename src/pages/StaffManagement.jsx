...
import { UserCheck, UserPlus, Search, Shield, Phone, Mail, Clock, CheckCircle, X, Key, Eye, EyeOff, Users, AlertCircle } from 'lucide-react';
              ...
              <div style={{ backgroundColor: '#f8fafc', border: '1px solid var(--border-color)', borderRadius: '10px', padding: '10px 12px', marginTop: '6px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '4px' }}>
                  ...
                  <button 
                    ...
                    style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#0284c7', fontSize: '11px', fontWeight: '700', display: 'flex', alignItems: 'center', gap: '4px' }}
                  >
                ...
                <div style={{ fontFamily: 'monospace', fontSize: '13.5px', fontWeight: '700', color: isPassVisible ? '#0369a1' : '#64748b' }}>
                  {isPassVisible ? (member.password || member.tempPassword || 'admin123') : '••••••••••••'}
                </div>
              </div>
