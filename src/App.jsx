...
import { LayoutDashboard, Package, ShoppingCart, Users, User, Activity, Tags, AlertTriangle, Clock, BarChart2, Mail, Copy, Check, ClipboardList, UserCheck, FlaskConical, Settings, Send, HeartHandshake, BellRing, ShieldAlert } from 'lucide-react';
  ...
  return (
    <div className="sidebar">
      ...
      <div className="nav-menu">
        ...
        {user?.role === 'owner' && (
          <Link to="/reconciliation" className={`nav-item ${path === '/reconciliation' ? 'active' : ''}`}>
            <ShieldAlert size={18} />
...
function Header() {
  ...
  const getTitle = () => {
    switch (location.pathname) {
      ...
      case '/reconciliation': return 'Stock Reconciliation';
